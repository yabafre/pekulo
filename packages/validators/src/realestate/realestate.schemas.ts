// packages/validators/src/realestate/realestate.schemas.ts
...
// ─── Enums ───────────────────────────────────────────────────────────────
// MIRROR of @pekulo/types#PROPERTY_TYPES — kept inline because validators cannot
// import from @pekulo/types (Turbo cycle constraint). Reviewer-enforced
// invariant: this literal MUST equal @pekulo/types#PROPERTY_TYPES exactly.
const PROPERTY_TYPES_MIRROR = ["residence-principale", "locatif", "autre"] as const;
export const propertyTypeSchema = z.enum(PROPERTY_TYPES_MIRROR);

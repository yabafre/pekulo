...
describe("PekuloErrorBoundary snapshot", () => {
  it("renders children when no error", () => {
    ...
    expect(container.innerHTML).toMatchInlineSnapshot(`"<span class="_dsp_contents  font_body"><span>ok</span><div style="display: contents;"></div></span>"`);
  });

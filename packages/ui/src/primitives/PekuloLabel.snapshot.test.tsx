...
describe("PekuloLabel snapshot", () => {
  it("renders bound to a control", () => {
    ...
    expect(container.innerHTML).toMatchInlineSnapshot(`
      ...
      </style><label data-slot="label" style="display: inline-flex; align-items: center; gap: 8px; font-size: 14px; font-weight: 500; line-height: 1; color: var(--color); user-select: none; cursor: default;" for="montant">Montant</label><div style="display: contents;"></div></span>"
    `);
  });
});

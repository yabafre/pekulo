...
describe("PekuloEmpty snapshot", () => {
  ...
  it("renders outlined", () => {
    ...
    expect(container.innerHTML).toMatchInlineSnapshot(
      `"<span class="_dsp_contents  font_body"><div data-slot="empty" class="is_View _fd-column _items-center _justify-center _gap-c-space-4 _pt-c-space-6 _pr-c-space-6 _pb-c-space-6 _pl-c-space-6 _btlr-c-radius-xl _btrr-c-radius-xl _bbrr-c-radius-xl _bblr-c-radius-xl _width-10037" style="text-align: center;"><div data-slot="empty-header" class="is_View _fd-column _items-center _gap-c-space-2 _maxW-400px"><h3 data-slot="empty-title" style="margin: 0px; color: var(--color); font-size: 14px; font-weight: 500; letter-spacing: -0.1px; line-height: 1.3; text-align: center;">Aucune transaction</h3></div></div><div style="display: contents;"></div></span>"`,
    );
  });
});

...
describe("PekuloInput snapshot", () => {
  it("renders default", () => {
    ...
    expect(container.innerHTML).toMatchInlineSnapshot(
      `"<span class="_dsp_contents  font_body"><input data-slot="input" class="pekulo-field" style="width: 100%; height: 40px; background-color: var(--backgroundMuted); color: var(--color); border-radius: 12px; padding: 0px 12px; font-size: 14px; border: none none; font-family: inherit;" aria-label="Libellé" placeholder="Courses Carrefour" type="text"><div style="display: contents;"></div></span>"`,
    );
  });

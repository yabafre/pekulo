...
describe("PekuloSkeleton snapshot", () => {
  ...
  it("renders block", () => {
    ...
    expect(container.innerHTML).toMatchInlineSnapshot(
      `"<span class="_dsp_contents  font_body"><div aria-hidden="true" class="is_View _width-10037 _height-120px _btlr-c-radius-md _btrr-c-radius-md _bbrr-c-radius-md _bblr-c-radius-md _bg-backgroundM3600254" style="animation: pekulo-skeleton-pulse 1.5s ease-in-out infinite;"></div><div style="display: contents;"></div></span>"`,
    );
  });
});
